					...
					<div class="table-container">
						<form class="ola" method="POST" action="{{ route('libro.store') }}"  role="form">
							...
							<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="apellido" id="npagina" class="form-control input-sm" placeholder="Apellido" required>
									</div>
								</div>
								...
								<div class="form-group row">
										...
										<div class="col-md-6">
												<input id="email" type="email" class="form-control input-sm{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="E-Mail" required>
								...
								<!-- <div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="password" name="password" id="nombre" class="form-control input-sm" placeholder="Contraseña" required>
									</div>
								</div>

								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="password" name="password" id="nombre" class="form-control input-sm" placeholder="Repetir contraseña" required>
									</div>
								</div> -->
